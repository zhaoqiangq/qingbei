$(document).ready(function(){
	...
	$("#sLeftBtnB").click(function(){
		if($(this).attr("class")=="sLeftBtnBSel") {
			...
			leftPosition=leftPositionNum+269+"px";
			if(leftPosition=="0px") {if($(this).attr("class") != "sLeftBtnBBan") {$(this).attr("class","sLeftBtnBBan");}}
			var bestLeftNum=-($(".scrolltab .ulSmallPic li").length-4)*269;
			if((leftPositionNum+269) > bestLeftNum && $("sRightBtnB").attr("class") != "sRightBtnB") {$("#sRightBtnB").attr("class","sRightBtnB")}
	...
	$("#sRightBtnB").click(function(){
		if($(this).attr("class")=="sRightBtnBSel"){
			...
			leftPosition=leftPositionNum-269+"px";
			var bestLeftNum=-($(".scrolltab .ulSmallPic li").length-4)*269;
			if((leftPositionNum-269)==bestLeftNum) {$(this).attr("class","sRightBtnBBan");}
